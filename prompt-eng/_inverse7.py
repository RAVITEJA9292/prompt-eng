...
if __name__ == "__main__":
    ...
    PROMPT = (
        "Step 1: Identify if the given matrix is invertible.\n"
        "Step 2: If it is invertible, apply the formula for matrix inversion.\n"
        "Step 3: Provide the final inverse matrix.\n"
        f"The given matrix is {MATRIX.tolist()}. Follow the above steps to solve it."
    )
